...
//Если winPlayer существует не равен null то победил winplayer
//След апгрейд логики


//Наша игра должна выводить, что раунт i, должна быть статистика после игры, победил ex Саша, начался 2-ой раунд, в конце
// Вывести на экран победителя
//С клавиатуры задать число до какого момента будет происходить игра
//Порядковый номер 1 2 3 4 игрок вася 1 Саша 2, порядок меняется
//Head first java
